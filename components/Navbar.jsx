...
export default function Navbar() {
  ...
  return (
    <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} transition={{ duration: 0.5 }}
     ...
     scrolled ? "navbar-scrolled" : "navbar" } border-b border-slate-200/50 dark:border-zinc-800/50`}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={toggle}
           className="px-4 py-2 rounded-lg bg-white text-black border border-slate-200 hover:bg-slate-100 transition-colors text-sm">
